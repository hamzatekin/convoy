...
export type TableBuilder<TShape extends TableShape, TIndexes extends TableIndexes<TShape> = {}> = TableDefinition<
  TShape,
  TIndexes
> & {
  index: <TName extends string, TFields extends readonly (keyof TShape & string)[]>(
    name: TName,
    fields: TFields,
